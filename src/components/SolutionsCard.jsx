...
const FrontendCard = () => {
  return (
    <div className="group max-w-sm mx-auto bg-[#2C2C2C] rounded-lg shadow-md overflow-hidden transform transition duration-500 hover:scale-105">
      ...
      <div className="p-6">
        <h2 className="text-3xl font-bold mb-2  text-white">Frontend Development</h2>
        ...
        <div className="mt-4 hidden group-hover:block transition-opacity duration-300 ease-in-out">
          <h3 className="text-xl font-semibold text-white mb-2">Our Frontend Skills</h3>
...
const SolutionsCard = () => {
  return (
    <>
      <h1 id='services' className='text-4xl text-white font-[400] py-8 px-12 text-left '>How we'll grow
